use crate::settings::{self, AutoSubmitKey, ClipboardHandling, OverlayPosition, PasteMethod, SoundTheme, TypingTool};
...
pub fn change_post_process_enabled_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    ...
    {
        if enabled {
            let _ = super::register_shortcut(&app, binding);
        } else {
            let _ = super::unregister_shortcut(&app, binding);
        }
    }
